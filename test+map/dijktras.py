#an a star can be converted to dijktras by changing its heurestic distance
## or we can say a star is advanced form of dijktras
...
for i in range(0, rows):
    ...
    grid[4][40].start(grey,0)
    grid[4][40].barrier=True
